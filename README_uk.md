...
- `--context-file <шлях>`: файл із контекстом для конкретного вводу; додається до користувацького промпту відразу після загального речення "Context" (діє для всіх блоків)
